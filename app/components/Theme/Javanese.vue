    ...
    <main :class="['light', isOpen ? '' : 'h-screen overflow-hidden']">
        ...
        <section
            ...
            <div class="min-h-screen w-full bg-primary flex flex-col justify-end items-center relative py-28 px-10">
                ...
                <div class="h-full flex flex-col justify-end items-center z-10">
                    <motion.img :initial="{ opacity: 0 }" :transition="{ duration: 1 }"
                        :while-in-view="{ opacity: 1, y: 0 }" src="/javanese/logo_emblem.svg" alt="logo"
                    ...
                    <motion.p :initial="{ opacity: 0, y: 50 }" :transition="{ duration: 1 }"
                        :while-in-view="{ opacity: 1, y: 0 }" class="mb-2 font-forum">WALIMATUL ‘URSY</motion.p>
                    <motion.h1 :initial="{ opacity: 0, y: 50 }" :transition="{ duration: 1 }"
                    ...
                    <motion.div :initial="{ opacity: 0, y: 50 }" :transition="{ duration: 1 }"
                        :while-in-view="{ opacity: 1, y: 0 }" class="space-y-4">
                        ...
                        <UButton class="mx-auto rounded-full" block @click="() => { isOpen = true }">Open invitation
                        </UButton>
                    </motion.div>
                </div>
            </div>
        ...
        <section class="bg-primary min-h-[600px] h-screen relative text-gold font-forum overflow-hidden">
            ...
            <div
                ...
                <div
                    class=" bg-gold mask-subtract mask-[url(/javanese/background-transition.png),url(/javanese/logo-background.svg)] absolute left-0 top-0 w-full h-screen mask-size-[100%] z-50 mask-center mask-no-repeat" />
                <div class="bg-gold absolute top-0 left-0 w-full h-1/5 z-50" />
                <div class="bg-gold absolute bottom-0 left-0 w-full h-1/5 z-50" />
            </div>

            <motion.img :initial="{ opacity: 0 }" :while-in-view="{ opacity: 1 }" :transition="{ duration: 1 }"
        ...
        <section class="min-h-screen bg-white relative flex flex-col text-black">
            ...
            <motion.img :initial="{ opacity: 0, y: -50 }" :while-in-view="{ opacity: 1, y: 0 }"
                :transition="{ duration: 1 }" src="/javanese/pattern_corner.svg" class="absolute top-6 left-2 w-28" />
            <motion.img :initial="{ opacity: 0, x: -50, y: 0 }" :while-in-view="{ opacity: 1, x: 0, y: 0 }"
                :transition="{ duration: 1 }" src="/javanese/pattern_corner.svg"
            ...
            <div class="grow py-20 px-14 font-forum space-y-16 text-center relative z-10">
                ...
                <div>
                    <motion.p :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                        :transition="{ duration: 1 }" class="font-bold text-xl text-primary">
                    ...
                    <motion.p :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                        :transition="{ duration: 1 }" class="text-primary font-bold text-4xl my-2">
                        &
                    </motion.p>
            ...
            <motion.img :initial="{ opacity: 0, scale: 0.8 }" :while-in-view="{ opacity: 0.2, scale: 1 }"
                :transition="{ duration: 1 }" src="/javanese/pattern2.svg"
        ...
        <section class="bg-primary relative">
            ...
            <div class="flex flex-col items-center px-14 py-20 font-forum relative z-10">
                <motion.h4 :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                    :transition="{ duration: 1 }" class="text-center text-2xl mb-4">
                    Menuju Hari Bahagia
                </motion.h4>

                <motion.div :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                    :transition="{ duration: 1 }" class="flex justify-between w-full px-16 mb-6">
                ...
                <motion.p :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                    :transition="{ duration: 1 }" class="mb-2">
                    MINGGU, 01 JUNI 2025
                </motion.p>
        ...
        <section class="bg-white min-h-96 font-forum text-black relative overflow-hidden">
            ...
            <div class="flex flex-col py-20 px-10 text-center">
                <motion.div :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                    :transition="{ duration: 1 }" class="flex items-center mb-4">
                ...
                <motion.p :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                    :transition="{ duration: 1 }" class="font-bold text-primary text-xl mb-2">
                    Minggu, 01 Juni 2025
                </motion.p>

                <motion.div :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                    :transition="{ duration: 1 }" class="grid grid-cols-2 divide-x mb-10">
                    <div>
                ...
                <motion.img :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                    :transition="{ duration: 1 }" src="/javanese/qr_loc.svg" alt="qr location"
                    class="w-16 mx-auto mb-2" />

                <motion.p :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                    :transition="{ duration: 1 }" class="font-bold">
                    di Ballroom Hotel Harper
                </motion.p>
                <motion.p :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                    :transition="{ duration: 1 }" class="text-pretty mb-6">
        ...
        <section class="bg-primary relative font-forum">
            ...
            <div class="flex flex-col items-center px-10 pt-4 pb-10 relative z-10 text-center text-white">
                <motion.p :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                    :transition="{ duration: 1 }" class="mb-4">
                    Berikan ucapan terbaik untuk Kedua Mempelai & Konfirmasi Kehadiran
                </motion.p>

                <motion.div :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                    :transition="{ duration: 1 }" class="space-y-2 w-full mb-4">
                    ...
                    <UFormField v-if="confimation === 'Hadir'" required :ui="{ label: '!text-white', root: 'w-full' }">
                        <UButtonGroup class="w-full">
                            <USelect v-model="tamu" color="neutral" variant="subtle" :items="tamuOption" class="w-full"
                ...
                <motion.div :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                    :transition="{ duration: 1 }" class="mt-4 overflow-y-auto h-48 w-full flex flex-col space-y-2">
                    <div class="flex gap-2 font-sans">
                        ...
                        <div class="text-left">
                            ...
                            <p class="text-sm">
                                Selamat fida dan calon suami Semoga dilancarkan segala rangkaian acaranya besok
                                Dijadikan keluarga yang
                                sakinah mawadah warahmah wabarokah, enggal diparingi momongan 🤲🏻🤲🏻🤲🏻🤭
                            </p>
                        </div>
                    </div>
                    <div class="flex gap-2 font-sans">
        ...
        <section class="bg-white min-h-96 font-forum text-black relative overflow-hidden">
            ...
            <motion.div :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                :transition="{ duration: 1 }" class="flex flex-col py-20 px-10 text-center">
        ...
        <section class="bg-primary relative font-forum text-gold">
            ...
            <div class="relative z-10 py-16 px-14 text-center">
                <motion.img :initial="{ opacity: 0, scale: 0.8 }" :while-in-view="{ opacity: 1, scale: 1 }"
                    :transition="{ duration: 1 }" src="/javanese/logo_emblem.svg" alt="logo" class="mb-8" />

                <motion.div :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                    :transition="{ duration: 1 }" class="mb-16">
                ...
                <motion.div :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                    ...
                    <div class="grid grid-cols-2">
                        <motion.div :initial="{ opacity: 0, y: 50 }" :while-in-view="{ opacity: 1, y: 0 }"
                            :transition="{ duration: 1 }" class="text-center">
